...
//                           return ProjectCard(project: project, fetchProjects: fetchProjects);
//                         },
//                       ),
...
//   final Function fetchProjects; // Add a callback to refresh projects

//   const ProjectCard({Key? key, required this.project, required this.fetchProjects}) : super(key: key);
...
//                   if (isMemberProject)
//                     IconButton(
//                       icon: const Icon(Icons.exit_to_app, color: Colors.red, size: 18), // Increased icon size
//                       tooltip: 'Leave Project',
//                       onPressed: () => _showLeaveConfirmationDialog(context, project['id']),
//                     ),
//                 ],
//               ),
//             ),
...
//                       'Team Members',
//                       style: TextStyle(
//                         fontSize: 12, // Further increased font size
//                         fontWeight: FontWeight.bold,
//                         color: Colors.black54,
//                       ),
//                     ),
...
//   void _showLeaveConfirmationDialog(BuildContext context, int projectId) {
//     showDialog(
//       context: context,
...
//                 await _leaveProject(context, projectId);
//               },
...
//         ScaffoldMessenger.of(context).showSnackBar(
//           const SnackBar(
//             content: Text('Successfully left the project'),
//             backgroundColor: Colors.green,
//           ),
//         );
//         fetchProjects(); // Call the callback to refresh projects
//       } else {
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(
//             content: Text('Failed to leave project: ${response.statusCode}'),
//             backgroundColor: Colors.red,
//           ),
//         );
//       }
