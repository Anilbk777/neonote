...
import 'package:project/goal_page.dart'; // Import the new GoalPage
              ...
              child: Container(
                ...
                child: ListView( // Use ListView to allow scrolling if content exceeds height
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ), // Add missing parenthesis for Container here
                          ],
                          // End Host Info
                    ...
                    // Goal Button
                    SizedBox( // Use SizedBox to constrain the button width if needed
                      width: double.infinity, // Make button take full width
                      child: ElevatedButton.icon(
                        icon: const Icon(Icons.track_changes), // Example icon
                        label: const Text(
                          'View Project Goal',
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => GoalPage(
                                ...
                                projectTitle: _titleController.text, // Pass the current title
                              ),
                             ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
                          padding: const EdgeInsets.symmetric(horizontal: 32, vertical: 20), // Adjust padding
